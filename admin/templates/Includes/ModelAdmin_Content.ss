<div class="cms-content cms-tabset center $BaseCSSClasses" data-layout-type="border" data-pjax-fragment="Content">
	...
	<div class="cms-content-header north">
		...
		<div class="cms-content-header-tabs cms-tabset-nav-primary ss-ui-tabs-nav">
			<button id="filters-button" class="icon-button font-icon-search no-text" data-collapsed="$DisplayFilters" title="<%t CMSPagesController_Tools_ss.FILTER 'Filter' %>"></button>
